...
| Custom Created | Include all findings with `SEVERE` priority |
...
Exact "gr" declarations:
  sys_script_include | Custom example | record: <record_sys_id> | origin: Custom Created | priority: SEVERE | exact-gr declarations: 1 | names: gr
